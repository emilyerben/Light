...
# Replicator
The reason that nanotechnology is not already dominating the global market is a manufacturing problem. In chemical reactions, nanoparticles are still produced under laboratory conditions, which costs a lot of money and a lot of time. Perhaps the most promising approach to designing replicators that can produce nanobots was provided by Robert Freitas and Ralph Merkle. They believe they can mass-produce nanobots and name their project Nanofactory. Here I would like to give an insight into the research of Robert Freitas and Ralph Merkle, who have been researching so-called mechanosynthesis for more than a decade. In contrast to chemosynthesis, mechanosynthesis positions specific atoms and can therefore produce any molecule, regardless of whether it is chemically reproducible or not. So it is possible to form completely new particles. Light plans to work with the Nanofactory Collaboration one day.
